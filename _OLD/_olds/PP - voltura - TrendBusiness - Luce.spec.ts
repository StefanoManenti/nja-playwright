...
const subFolder = "PP_VOLTURA_LUCE";
const path = `tests/screens/${subFolder}`;
const screenName = subFolder.toLowerCase()+"_";

//Voltura -> trend businness > luce
const startUrl ="https://pp.eniplenitude.com/configura-offerta?codiceProdotto=BASE_LTCASAV-GTCASAV&codiceCanale=CWEB3EGP&codiceTpCanale=WB&direct-debit=true&bill-type=digitale&commodity=luce&salesProcess=TRANSFER&dev=true"

test("PP - Voltura / Trend Business / Luce", async ({ page }) => {
