...
import { test } from "./utils/loggedTest";import {
  WAIT,
  addScriptRuntime,
  autoFillForm,
  clearScreenshots,
...
const subFolder = "PP_ADOTTA_PANNELLO";
const path = `tests/screens/${subFolder}`;
const screenName = subFolder.toLowerCase()+"_";

//Adotta un pannello standalone
const startUrl = "https://pp.eniplenitude.com/my-eni?codiceProdotto=BASE_PANNELLO&codiceCanale=CWEB3EGP&codiceTpCanale=WB&direct-debit=true&bill-type=digitale&salesProcess=AGGIUNGI_PANNELLO&panel=&redirPagina=38&chiamante=null&dev=true";

test("PP - Adotta pannello", async ({ page }) => {
