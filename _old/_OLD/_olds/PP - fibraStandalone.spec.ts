...
const subFolder = "PP_FIBRA_STANDALONE";
const path = `tests/screens/${subFolder}`;
const screenName = subFolder.toLowerCase()+"_";
const startUrl ="https://pp.eniplenitude.com/configura-offerta?codiceProdotto=BASE_BB&codiceCanale=CWEB3EGP&codiceTpCanale=WB&direct-debit=true&bill-type=digitale&salesProcess=BROADBAND&fiber=&dev=true";

test("PP - Fibra standalone", async ({ page }) => {
