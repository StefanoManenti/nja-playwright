...
const startUrl = `http://localhost:4200/configura-offerta?codiceProdotto=BASE_LTCASAV-GTCASAV&codiceCanale=CWEB3EGP&codiceTpCanale=WB&direct-debit=true&bill-type=digitale&commodity=luce&salesProcess=SWITCH_IN_TRANSFER&mocks&dev`
...
test(`SWITCH IN CON VOLTURA LUCE`, async ({ page }) => {
  ...
  const subFolder = 'SWITCH_IN_CON_VOLTURA_LUCE';
