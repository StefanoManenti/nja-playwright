...
const subFolder = "PP_NA_TRENDCASA_GAS";
const path = `tests/screens/${subFolder}`;
const screenName = subFolder.toLowerCase() + "_";

//NA -> trendcasa > gas
const startUrl =
  "https://pp.eniplenitude.com/configura-offerta?codiceProdotto=BASE_LTCASAV-GTCASAV&codiceCanale=CWEB3EGP&codiceTpCanale=WB&direct-debit=true&bill-type=digitale&commodity=gas&salesProcess=NEW_ACTIVATION&dev=true";

test("PP -Nuova Attivazione / Trend Casa / Gas", async ({ page }) => {
