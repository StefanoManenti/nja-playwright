...
const subFolder = "DEV_FIBRA_STANDALONE";
const path = `tests/screens/${subFolder}`;
const screenName = subFolder.toLowerCase() + "_";
const startUrl =
  "http://localhost:4200/configura-offerta?codiceProdotto=BASE_BB_BS07&codiceCanale=CWEB3EGP&codiceTpCanale=WB&direct-debit=true&bill-type=digitale&salesProcess=BROADBAND&fiber=&mocks&dev";

test("DEV - Fibra standalone", async ({ page }) => {
