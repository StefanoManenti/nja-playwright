...
const startUrl = `http://localhost:4200/configura-offerta?codiceProdotto=BASE_LFIXATIV-GFIXATIV&codiceCanale=CWEB3EGP&codiceTpCanale=WB&direct-debit=true&bill-type=digitale&commodity=gas&salesProcess=SWITCH_IN&mocks&dev`

test(`SWITCH FIXA GAS IBAN ITA`, async ({ page }) => {
  // Lista Step
  ...
  const subFolder = 'SWITCH_FIXA_GAS_IBAN_ITA';
