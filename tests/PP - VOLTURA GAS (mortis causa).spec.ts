...
const startUrl = `${baseUrl}codiceProdotto=BASE_LTCASAV-GTCASAV&codiceCanale=CWEB3EGP&codiceTpCanale=WB&direct-debit=true&bill-type=digitale&commodity=gas&salesProcess=TRANSFER&dev=&segment=res`

test(`PP - VOLTURA GAS (mortis causa)`, async ({ page }) => {
  // Lista Step
