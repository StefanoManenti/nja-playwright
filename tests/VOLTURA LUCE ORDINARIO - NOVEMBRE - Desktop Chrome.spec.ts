...
const startUrl = `http://localhost:4200/configura-offerta?codiceProdotto=BASE_LTCASAV-GTCASAV&codiceCanale=CWEB3EGP&codiceTpCanale=WB&direct-debit=true&bill-type=digitale&commodity=luce&salesProcess=TRANSFER&mocks&dev`;
...
test(`VOLTURA LUCE ORDINARIO`, async ({ page }) => {
  ...
  const subFolder = "VOLTURA_LUCE_ORDINARIO";
