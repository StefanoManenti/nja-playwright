...
const startUrl = `${baseUrl}codiceProdotto=BASE_LTCASAV-GTCASAV&codiceCanale=CWEB3EGP&codiceTpCanale=WB&direct-debit=true&bill-type=digitale&commodity=luce&salesProcess=CHANGE_OFFER`

test(`PP - CAMBIO PRODOTTO LUCE`, async ({ page }) => {
  // Lista Step
  ...
  const subFolder = prefix +'CAMBIO_PRODOTTO_LUCE';
