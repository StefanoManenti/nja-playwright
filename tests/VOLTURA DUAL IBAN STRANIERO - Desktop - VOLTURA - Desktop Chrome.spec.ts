...
const startUrl = `http://localhost:4200/configura-offerta?mocks&dev&codiceProdotto=BASE_LTCASAV-GTCASAV&codiceCanale=CWEB3EGP&codiceTpCanale=WB&direct-debit=true&bill-type=digitale&commodity=gaseluce&salesProcess=TRANSFER`

test(`VOLTURA DUAL IBAN STRANIERO - Desktop`, async ({ page }) => {
  // Lista Step
  ...
  const subFolder = 'VOLTURA_DUAL_IBAN_STRANIERO_DESKTOP';
