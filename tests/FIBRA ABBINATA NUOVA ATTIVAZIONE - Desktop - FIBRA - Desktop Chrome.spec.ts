...
const startUrl = `http://localhost:4200/configura-offerta?mocks&dev&codiceProdotto=BASE_BB&codiceCanale=CWEB3EGP&codiceTpCanale=WB&direct-debit=true&bill-type=digitale&commodity=gaseluce&salesProcess=NEW_ACTIVATION&fiber=BASE_BB&egonid=380100013650019`

test(`FIBRA ABBINATA NUOVA ATTIVAZIONE - Desktop`, async ({ page }) => {
  // Lista Step
  ...
  const subFolder = 'FIBRA_ABBINATA_NUOVA_ATTIVAZIONE_DESKTOP';
