...
const startUrl = `http://localhost:4200/configura-offerta?codiceProdotto=BASE_LTCASAV-GTCASAV&codiceCanale=CWEB3EGP&codiceTpCanale=WB&direct-debit=true&bill-type=digitale&commodity=luce&salesProcess=NEW_ACTIVATION&mocks&dev`

test(`POSA E ATTIVAZIONE LUCE (posa)`, async ({ page }) => {
  // Lista Step
  ...
  const subFolder = 'POSA_E_ATTIVAZIONE_LUCE_POSA';
