...
const startUrl = `http://localhost:4200/configura-offerta?mocks&dev&codiceProdotto=BASE_LTCASAV-GTCASAV&codiceCanale=CWEB3EGP&codiceTpCanale=WB&direct-debit=true&bill-type=digitale&commodity=luce&salesProcess=TRANSFER`

test(`VOLTURA LUCE ORDINARIO - Desktop`, async ({ page }) => {
  // Lista Step
  ...
  const subFolder = 'VOLTURA_LUCE_ORDINARIO_DESKTOP';
